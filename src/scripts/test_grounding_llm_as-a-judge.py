...
archivo_excel = "src/rag_system/excel_test/test.xlsx"
...
for index, fila in df.iterrows():
    ...
    respuesta_guardada = fila["Respuestas"]
    ...
    contexto_rag_actual = get_context_rag(pregunta)
...
df_resultados.to_excel("src/rag_system/excel_test/test_grounding.xlsx", index=False)
print("Evaluación completada y guardada en 'test_grounding.xlsx'.")